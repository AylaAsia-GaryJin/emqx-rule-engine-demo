...
@Slf4j
@Component
public class PropertyRocketMqListener implements MessageListener {
    ...
    public Action consume(Message message, ConsumeContext context) {
        try {
            ...
            log.info("Receive property message by msgID: {},msgKey:{}，bornTimestamp: {}，message: {}，msgBody: {}",
                msgId, msgKey, bornTimestamp, message, msg);
            MessageRecord messageRecord = new MessageRecord()
                .setMessageId(msgId)
                .setMessageType("rockemq_property")
