...
@Slf4j
@Component
public class EventRocketMqListener implements MessageListener {
    ...
    public Action consume(Message message, ConsumeContext context) {
        try {
            ...
            log.info("Receive event message by msgID: {},msgKey:{}，bornTimestamp: {}，message: {}，msgBody: {}",
                msgId, msgKey, bornTimestamp, message, msg);
            MessageRecord messageRecord = new MessageRecord()
                .setMessageId(msgId)
                .setMessageType("rockemq_event")
